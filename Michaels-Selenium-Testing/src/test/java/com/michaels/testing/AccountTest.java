...
public class AccountTest extends ERBaseTest {
    ...
    private void navigateAndReady(String url) {
        ...
        try {
            ...
            System.out.println("Michaels blocked the page or showed a Captcha. Skipping further steps.");
            // This prevents the whole suite from crashing if one page is blocked
        }
    }
